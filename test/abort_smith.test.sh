...
SCRIPT="${ROOT}/bin/abort_smith.sh"
...
( cd "$TARGET" && bash "${ROOT}/bin/make_worktree.sh" APP-1234 task/app-1234-foo )
mkdir -p .smith/briefs
echo "# Brief" > .smith/briefs/APP-1234-brief.md
bash "${ROOT}/bin/active_smiths.sh" add smith-APP-1234 anderson-APP-1234 impl APP-1234
...
# active_smiths empty
got=$(bash "${ROOT}/bin/active_smiths.sh" count)
...
( cd "$TARGET" && bash "${ROOT}/bin/make_worktree.sh" APP-2222 task/app-2222-bar )
mkdir -p .smith/briefs
echo "# Brief" > .smith/briefs/APP-2222-brief.md
bash "${ROOT}/bin/active_smiths.sh" add smith-APP-2222 anderson-APP-2222 impl APP-2222
...
( cd "$TARGET" && bash "${ROOT}/bin/checkout_pr_worktree.sh" APP-3333 task/app-3333-baz )
bash "${ROOT}/bin/active_smiths.sh" add smith-pr-5050 anderson-pr-5050 fixer 5050
...
( cd "$TARGET" && bash "${ROOT}/bin/make_worktree.sh" APP-4444 task/app-4444-qux )
...
bash "${ROOT}/bin/active_smiths.sh" add smith-APP-4444 anderson-APP-4444 impl APP-4444
